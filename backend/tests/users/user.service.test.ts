  ...
  it("throws error if first name is invalid", async () => {
	...
	it("throws error if description is invalid", async () => {
		await expect(
			service.createUser({
				...userFields,
				description: "Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean ma", // more than 100 characters
			} as any)
...
describe("UserService.getPage", () => {
	...
	it("throws error if page is less than 1", async () => {
		await expect(
			service.getPage({ page: 0, limit: 10 })
		).rejects.toThrow(
			"Page and limit must be integers. Page >= 1, limit >= 1, limit <= 100"
		);
	});
	...
	it("throws error if limit is less than 1", async () => {
		await expect(
			service.getPage({ page: 1, limit: 0 })
		).rejects.toThrow(
			"Page and limit must be integers. Page >= 1, limit >= 1, limit <= 100"
		);
	});
	...
	it("throws error if limit is greater than 100", async () => {
		await expect(
			service.getPage({ page: 1, limit: 101 })
		).rejects.toThrow(
			"Page and limit must be integers. Page >= 1, limit >= 1, limit <= 100"
		);
	});
	...
	it("throws error if page is not an integer", async () => {
		await expect(
			service.getPage({ page: 1.5, limit: 10 })
		).rejects.toThrow(
			"Page and limit must be integers. Page >= 1, limit >= 1, limit <= 100"
		);
	});
	...
	it("throws error if limit is not an integer", async () => {
		await expect(
			service.getPage({ page: 1, limit: 10.5 })
		).rejects.toThrow(
			"Page and limit must be integers. Page >= 1, limit >= 1, limit <= 100"
		);
	});
	...
	it("throws error if page is not a number", async () => {
		await expect(
			service.getPage({ page: "abc", limit: 10 })
		).rejects.toThrow(
			"Page and limit must be integers. Page >= 1, limit >= 1, limit <= 100"
		);
	});
	...
	it("throws error if limit is not a number", async () => {
		await expect(
			service.getPage({ page: 1, limit: "abc" })
		).rejects.toThrow(
			"Page and limit must be integers. Page >= 1, limit >= 1, limit <= 100"
		);
	});
